...
LAB52:    t458 = (t0 + 3992);
    ...
    *((unsigned int *)t468) = (t470 | t464);
    xsi_driver_vfirst_trans(t458, 0, 1);
    t471 = (t0 + 3896);
    *((int *)t471) = 1;
...
LAB76:    memcpy(t339, t234, 8);

LAB77:    memset(t371, 0, 8);
    t372 = (t339 + 4);
...
LAB126:    if (*((unsigned int *)t441) != 0)
        goto LAB127;

LAB128:    t448 = (t162 + 4);
    t449 = *((unsigned int *)t162);
    t450 = *((unsigned int *)t448);
    t451 = (t449 || t450);
    if (t451 > 0)
        goto LAB129;

LAB130:    t453 = *((unsigned int *)t162);
    t454 = (~(t453));
...
LAB132:    if (*((unsigned int *)t448) > 0)
        goto LAB133;

LAB134:    if (*((unsigned int *)t162) > 0)
        goto LAB135;

LAB136:    memcpy(t161, t457, 8);
...
LAB87:    memcpy(t303, t264, 8);

LAB88:    memset(t331, 0, 8);
    t332 = (t303 + 4);
...
LAB101:    if (*((unsigned int *)t332) != 0)
        goto LAB102;

LAB103:    t340 = *((unsigned int *)t234);
...
LAB94:    if (*((unsigned int *)t296) != 0)
        goto LAB95;

LAB96:    t304 = *((unsigned int *)t264);
...
LAB119:    if (*((unsigned int *)t402) != 0)
        goto LAB120;

LAB121:    t410 = *((unsigned int *)t371);
...
LAB129:    t452 = ((char*)((ng3)));
    goto LAB130;

LAB131:    t457 = ((char*)((ng4)));
    goto LAB132;

LAB133:    xsi_vlog_unsigned_bit_combine(t161, 2, t452, 2, t457, 2);
    goto LAB137;

LAB135:    memcpy(t161, t452, 8);
    goto LAB137;
...
extern void work_m_00000000001340812226_1081490573_init()
{
	static char *pe[] = {(void *)Cont_141_0,(void *)Cont_144_1};
	xsi_register_didat("work_m_00000000001340812226_1081490573", "isim/tb_pipeline_MIPS_32bit_isim_beh.exe.sim/work/m_00000000001340812226_1081490573.didat");
