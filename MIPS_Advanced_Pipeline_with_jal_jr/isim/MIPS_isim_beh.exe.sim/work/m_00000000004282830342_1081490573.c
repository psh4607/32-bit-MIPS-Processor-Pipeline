...
#endif
static const char *ng0 = "C:/Users/HO_win7/Documents/FPGA/Advanced_withj/Advancedwithj/forwarding_unit.v";
...
LAB48:    t415 = (t0 + 3992);
    ...
    *((unsigned int *)t425) = (t427 | t421);
    xsi_driver_vfirst_trans(t415, 0, 1);
    t428 = (t0 + 3896);
    *((int *)t428) = 1;
...
LAB68:    memcpy(t296, t200, 8);

LAB69:    memset(t328, 0, 8);
    t329 = (t296 + 4);
...
LAB104:    memcpy(t366, t328, 8);

LAB105:    memset(t145, 0, 8);
    t398 = (t366 + 4);
...
LAB120:    t405 = (t145 + 4);
    t406 = *((unsigned int *)t145);
    t407 = *((unsigned int *)t405);
    t408 = (t406 || t407);
    if (t408 > 0)
        goto LAB121;

LAB122:    t410 = *((unsigned int *)t145);
    t411 = (~(t410));
...
LAB124:    if (*((unsigned int *)t405) > 0)
        goto LAB125;

LAB126:    if (*((unsigned int *)t145) > 0)
        goto LAB127;

LAB128:    memcpy(t144, t414, 8);
...
LAB121:    t409 = ((char*)((ng2)));
    goto LAB122;

LAB123:    t414 = ((char*)((ng3)));
    goto LAB124;

LAB125:    xsi_vlog_unsigned_bit_combine(t144, 2, t409, 2, t414, 2);
    goto LAB129;

LAB127:    memcpy(t144, t409, 8);
    goto LAB129;
...
extern void work_m_00000000004282830342_1081490573_init()
{
	static char *pe[] = {(void *)Cont_7_0,(void *)Cont_10_1};
	xsi_register_didat("work_m_00000000004282830342_1081490573", "isim/MIPS_isim_beh.exe.sim/work/m_00000000004282830342_1081490573.didat");
